     ...
     <>
       ...
       <div className='flex items-center justify-center p-5 border-[1px] rounded-md w-full'>
           <div className='flex gap-5 w-2/4'>
               <Input placeholder='Enter Receipt Reference Number'  type='number' onChange={(e)=>setQuery(e.target.value)} className='w-full'/>
       ...
       <div className='p-5 border-[1px] rounded-md w-full'>
           ...
           <div className='flex gap-10 w-full my-8'>
               <div className='flex gap-5 w-1/2'>
                   ...
                   <Input placeholder='invoice number' value={searchedData.invoicenumber} className='w-3/4' disabled/>
               </div>
               <div className='flex gap-2 w-1/2'>
                   <Label>Invoice Date</Label>
                   <Input placeholder='Invoice date' value={searchedData.invoicedate} className='w-3/4' disabled/>
               </div>
           </div>
           <div className='flex gap-10 w-full my-8'>
               <div className='flex gap-5 w-1/2'>
           ...
           <div className='flex gap-10 w-full my-8'>
               <div className='flex gap-5 w-1/2'>
                   ...
                   <Input placeholder='supplier' className='w-3/4' value={searchedData.supplier}  disabled/>
               </div>
               <div className='flex gap-2 w-1/2'>
                   <Label>Remarks</Label>
